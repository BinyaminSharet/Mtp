...
class MtpDevicePropertyTest(BaseTestCase):
    ...
    def testUint8PropertyDesc(self):
        ...
        uut = MtpDeviceProperty(MtpDevicePropertyCode.BatteryLevel, 0, UInt8(0x27), UInt8(0))
    ...
    def testUint16PropertyDesc(self):
        ...
        uut = MtpDeviceProperty(MtpDevicePropertyCode.BatteryLevel, 0, UInt16(0x1234), UInt16(0))
        self.assertEqual(uut.get_desc(), expected)
    ...
    def testUint32PropertyDesc(self):
        ...
        uut = MtpDeviceProperty(MtpDevicePropertyCode.BatteryLevel, 0, UInt32(0x11223344), UInt32(0x55667788))
        self.assertEqual(uut.get_desc(), expected)
